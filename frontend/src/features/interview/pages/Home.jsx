...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        const resumeFileFromInput = resumeInputRef.current?.files?.[0] || resumeFile

        try {
            const data = await generateReport({
                jobDescription,
                selfDescription,
                resumeFile: resumeFileFromInput
            })
                        ...
                        <div className='upload-section'>
                            ...
                            {resumeFile && !resumeError && (
                                <div className='resume-success'>
                                    ...
                                    <div className='resume-success__icon'>
                                        ✓
                                    </div>

                                    <div className='resume-success__details'>
